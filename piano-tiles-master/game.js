...
function playMusic() {
    ...
    var selectedMusic = musicSelector.value; // Get the selected music file from the dropdown
    audio.src = selectedMusic; // Set the src attribute of the Audio element to the selected music file
...
var backgrounds = ["img1.jpg","img18.jpeg","img2.jpg","img3.jpg","img4.jpg","img5.jpg","img6.jpg","img7.jpg","img8.jpg","img9.jpg","img10.jpg","img11.jpg","img12.jpg","img13.jpg","img14.jpg","img15.jpg","img16.jpg","img17.jpg"]; // Paths to your background images
var currentBackgroundIndex = 0;

// function changeBackground() {
//     var htmlElement = document.documentElement; // Reference to <html> element
//     htmlElement.style.backgroundImage = "url('" + backgrounds[currentBackgroundIndex] + "')";
// }

function changeBackground() {
    var backgroundElement = document.getElementById("background1"); // Reference to the #background element
    var imageUrl = backgrounds[currentBackgroundIndex];
    // console.log("Changing background to:", imageUrl); // Log the image URL for debugging
